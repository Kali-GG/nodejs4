...
var game = new Phaser.Game(800, 600, Phaser.CANVAS, 'game-div', { create: create, update: update, render: render });
...
if (cursors.down.isDown) { motorSpeed = 0; console.log('truckBody: ' + truckBody);} // prioritize braking
